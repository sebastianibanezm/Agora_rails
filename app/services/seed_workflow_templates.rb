class SeedWorkflowTemplates
  ...
  TEMPLATE_FIELDS = {
    "master_agreement" => %w[shipper_name hs_code incoterm],
    "purchase_order" => %w[consignee notify_party incoterm package_count invoice_amount product_description],
    "product_spec" => %w[hs_code product_description net_weight],
    "certificate_of_analysis" => %w[lot_number product_description],
    "booking_confirmation" => %w[container_number pol pod],
    "shipping_instruction" => %w[shipper_name consignee notify_party hs_code product_description net_weight gross_weight package_count container_number pol pod incoterm],
    ...
    "commercial_invoice" => %w[shipper_name consignee hs_code product_description package_count net_weight incoterm invoice_amount],
    "packing_list" => %w[package_count net_weight gross_weight container_number seal_number product_description],
    "certificate_of_origin" => %w[shipper_name consignee hs_code product_description invoice_amount],
    "bl_matrix" => %w[shipper_name consignee notify_party hs_code product_description package_count net_weight gross_weight container_number seal_number pol pod incoterm],
    ...
    "documentary_set" => %w[shipper_name consignee invoice_amount],
    "payment_reconciliation" => %w[invoice_amount],
  }.freeze
